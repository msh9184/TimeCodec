#!/bin/bash
# Configure DATA_ROOT to point to the directory containing raw SWAT data
...
python anomaly_detection/detect_anomaly.py \
    --dataset "SWAT"\
    --trained_vqvae_model_path "anomaly_detection/saved_models/SWAT/CD64_CW1024_CF4_BS4096_ITR15000_seed${seed}/checkpoints/final_model.pth" \
