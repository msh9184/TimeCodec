#!/bin/bash
# Configure DATA_ROOT to point to the directory containing raw SMD data
...
python anomaly_detection/detect_anomaly.py \
    --dataset "SMD"\
    --trained_vqvae_model_path "anomaly_detection/saved_models/SMD/CD64_CW1024_CF4_BS4096_ITR60000_seed${seed}/checkpoints/final_model.pth" \
